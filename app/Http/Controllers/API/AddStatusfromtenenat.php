        ...
        try {
            ...
            switch ($actionType) {
                case '0':
                    ...
                    $record->visitor_remark = !empty($validatedData['proveRemark']) 
                    ? $validatedData['proveRemark'] 
                    : 'Approve';
                    break;
                ...
                case '1':
                   ...
                   $record->visitor_remark = !empty($validatedData['rejectRemark']) 
                    ? $validatedData['rejectRemark'] 
                    : 'Reject';
                    break;
