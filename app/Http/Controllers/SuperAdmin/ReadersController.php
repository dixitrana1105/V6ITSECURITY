...
class ReadersController extends Controller
{
    ...
    public function store_reader(Request $request)
    {
        $request->validate([
            ...
            'serial_id' => 'required|unique:readers,serial_id'
        ], [
            'serial_id.unique' => 'This Serial ID already exists. Please enter a unique value.',
        ]);
    ...
    public function update(Request $request, $id)
    {
        ...
        $request->validate([
            'building_id' => 'required',
            'serial_id' => 'required|unique:readers,serial_id,' . $reader->id,            
        ], [
            'serial_id.unique' => 'This Serial ID already exists. Please enter a unique value.',
        ]);
