<x-layout.default>
    ...
    <div
        ...
        <div class="panel shadow-lg rounded-lg p-8 max-w-6xl mx-auto "
            ...
            <form action="{{ route('building-security.pre-visitor-store') }}" method="POST" enctype="multipart/form-data">
                @csrf

                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">

                    {{-- preApproveMatchVisitor --}}
                    {{-- {{ dd($preApproveMatchVisitor->id); }} --}}

                    {{-- <input id="VisitorId" type="hidden" name="tenant_visitore_id" value="{{ $preApproveMatchVisitor->id ?? '' }}"
                   class="form-input" required readonly /> --}}
                    ...
                    <div>
                        ...
                        <input id="VisitorId" type="text" name="VisitorId" value="{{ $preApproveMatchVisitor->visitor_id ?? '' }}"
                    ...
                    {{-- <input type="hidden" name="visitor_id" value="{{ $preApproveMatchVisitor->visitor_id ?? '' }}"> --}}
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <input id="full_name" name="full_name" value="{{ $preApproveMatchVisitor->full_name ?? '' }}" type="text"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        ...
                        <input type="hidden" id="id_captured_image" name="id_file" required/>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <select id="tenant_flat_office_no" name="tenant_flat_office_no" class="form-input" required>
                            ...
                            @if(!empty($preApproveMatchVisitor->tenant_flat_office_no))
                                <option value="{{ $preApproveMatchVisitor->tenant_flat_office_no }}" selected>
                                    {{ $preApproveMatchVisitor->tenant_flat_office_no }}
                                </option>
                            @endif
                        </select>
                    </div>
