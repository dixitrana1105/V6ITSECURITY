            ...
            <form action="{{route('building-admin.tenant-store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <div>
                        ...
                        <input id="registerDate" type="date" name="date" style="width: 100%" class="form-input"
                            required />
                    </div>
                </div>
                <br>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        ...
                        <input id="tenantId" type="text" name="tenantId" placeholder="Auto Generate"
                            value="{{ $nextId }}" class="form-input" required readonly />
                    </div>
                    <div>
                        ...
                        <input id="flat_office_number" name="flat_office_number" type="number"
                            placeholder="Enter Flat Office Number" class="form-input" required />
                    </div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        <label for="sub_user"><strong>No. of Sub user Allow</strong></label>
                        <input id="sub_user" name="sub_user" type="number" placeholder="Enter No. of Sub user Allow"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <input id="contact" name="contact" type="number" placeholder="Enter contact number"
                            class="form-input" required />
                    </div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        ...
                        <input id="whatsup" name="whatsup" type="number" placeholder="Enter whatsApp Number"
                            class="form-input" required />
                    </div>
                    <div>
                        <label for="emer_number"><strong>Emergency Contact Number</strong></label>
                        <input id="emer_number" name="emer_number" type="number"
                            placeholder="Enter emergency Contact Number" class="form-input" required />
                    </div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        <label for="fromTime"><strong>Visiting Hour (From)</strong></label>
                        <input id="fromTime" name="fromTime" type="time" placeholder="Enter Visiting Time"
                            class="form-input" required />
                    </div>
                    <div>
                        <label for="toTime"><strong>Visiting Hour (To)</strong></label>
                        <input id="toTime" name="toTime" type="time" placeholder="Enter Visiting Time"
                            class="form-input" required />
                    </div>
                </div>
    ...
    <div style="position: relative;">
        ...
        <span style="position: absolute; right: 10px; top: 50%; transform: translateY(-50%); cursor: pointer;" onclick="this.previousElementSibling.type = this.previousElementSibling.type === 'password' ? 'text' : 'password'">👁️</span>
                    ...
                    <div>
                        ...
                        <input id="secretkey" name="secretkey" type="text" placeholder="secret Key"
                            class="form-input" />
                    </div>
                </div>
                <div>
