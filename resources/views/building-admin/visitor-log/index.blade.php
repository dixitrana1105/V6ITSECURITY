<x-layout.default>
    ...
    <form method="GET" action="{{ route('building-admin.visitor-log') }}" class="flex justify-start items-center mb-4 space-x-4">
...
<tr>
            ...
            <td class="py-2 px-8">
    <img src="{{ asset($security->photo) }}" alt="image" class="object-cover w-30 h-32 mb-5" />
</td>
        ...
        <td class="py-2 px-8">{{ $security->full_name }}</td>
            ...
            <td class="py-2 px-8">
                            <img src="{{ asset($security->id_proof) }}" alt="image" class="object-cover w-30 h-32 mb-5" />
                        </td>
