        ...
        <table class="min-w-full shadow-lg rounded-lg overflow-hidden">
            ...
            <tbody>
                ...
                <tr class="border-b duration-300">
                    ...
                    <!--        <form class="flex flex-col gap-2 items-center" action="{{ route('school.security.visitor-card-assign', $item->id) }}"-->
                    <!--            method="post">-->
                    <!--            @csrf-->
                    <!--            @method('PATCH')-->
                    <!--            <div class="w-32">-->
                    ...
                    <!--        </form>-->
                    <!--        @else-->
                    <!--            {{ $item->card?->serial_id ?? "N/A" }}-->
                    <!--        @endif-->
                    <!--    </td>-->
                    <!--    <td>-->
                           @php
                                $statusColor = match($item->card_status) {
                           ...
                           @endphp
                    <!--        <span class="{{ $statusColor }}">{{ $item->card_status ?? 'N/A' }}</span>-->
                    <!--    </td>-->
                    {{-- <td>{{ $item->card->serial_id ?? ''}}</td> --}}
                    <td>{{ $item->date}}</td>
                    <td>
                                        ...
                                        <div x-show="open" x-transition x-transition.duration.300
                                            ...
                                            <div class="p-5">
                                                @php
                                                    ...
                                                    $visitor = App\Models\SchoolSecurityVisitor::with('card')->where('visitor_id_detected',$visitorId)->get();
                                                @endphp
                   ...
                   <td>
                        ...
                        <form action="{{route('school.security.visitor.unblock')}}" method="POST">
                            @csrf
                            <input type="hidden" name="unblockvisitor" value="{{$item->visitor_id_detected}}"/>
                            <button
