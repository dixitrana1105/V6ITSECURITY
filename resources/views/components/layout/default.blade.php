...
<body x-data="main" class="antialiased relative font-nunito text-sm font-normal overflow-x-hidden"
    ...
    <div class="main-container text-black dark:text-white-dark min-h-screen" :class="[$store.app.navbar]">
        ...
        @if (Request::is(
                'building/dashboard',
                'building-admin/card-index',
                'building-admin/reader-index',
        ...
        @php
            $isSecurityRoute = Request::is([
                ...
                'building-security/card-history',
                ...
                'building-security/card-index',
                'building-security/pre-visitor-create',
                ...
                'newMessages*', // Only include this in security routes
            ]);
        ...
        @if (Request::is(
                ...
                'school-admin/card-index',
                'school-admin/reader-index',
        ...
        @if (Request::is(
                ...
                'school/security/card-history',
                'school/security/visitor/alerts',
