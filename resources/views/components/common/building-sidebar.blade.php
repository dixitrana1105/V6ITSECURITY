        ...
        <div class="bg-white dark:bg-[#0e1726] h-full">
            ...
            <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0"
                ...
                <li class="menu nav-item">
                    <a href="/building/dashboard" class="nav-link group">
                    ...
                    <ul>
                        <li class="menu nav-item">
                            <button type="button" class="nav-link group"
                                :class="{ 'active': activeDropdown === 'tenant' }"
                                @click="activeDropdown === 'tenant' ? activeDropdown = null : activeDropdown = 'tenant'">
                                <div class="flex items-center">

                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M3 21V9L12 3L21 9V21H14V15H10V21H3Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                ...
                                <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'tenant' }">
                            ...
                            <ul x-cloak x-show="activeDropdown === 'tenant'" x-collapse
                                class="sub-menu text-gray-500">
                                <li>
                                    <a href="/building-admin/tenant-index">List</a>
                                </li>
                                <li>
                                    <a href="/building-admin/tenant-create">Add</a>
                                </li>
                            </ul>
                        </li>
                        <li class="menu nav-item">
                            <button type="button" class="nav-link group"
                                ...
                                <div class="flex items-center">
                                    ...
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M12 2L3 6V11C3 16 7 20.5 12 22C17 20.5 21 16 21 11V6L12 2Z"
                                ...
                                <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'security' }">
                                    ...
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Right arrow">
                                    <path d="M9 5L15 12L9 19" stroke="currentColor" stroke-width="1.5"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                            ...
                            <ul x-cloak x-show="activeDropdown === 'security'" x-collapse
                                class="sub-menu text-gray-500">
                                <li>
                                    <a href="/building-admin/security-index">List</a>
                                </li>
                                <li>
                                    <a href="/building-admin/security-create">Add</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group"
                        :class="{ 'active': activeDropdown === 'reader' }"
                        @click="activeDropdown === 'reader' ? activeDropdown = null : activeDropdown = 'reader'">
                        <div class="flex items-center">

                            <!-- Example icon for Card (can be changed) -->
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M3 6C3 4.89543 3.89543 4 5 4H19C20.1046 4 21 4.89543 21 6V8H3V6Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
                                <path d="M3 10H21V18C21 19.1046 20.1046 20 19 20H5C3.89543 20 3 19.1046 3 18V10Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
                                <path d="M7 14H10" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
                            </svg>

                            <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Reader</span>
                        </div>
                        <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'reader' }">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'reader'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="/building-admin/reader-index">List</a>
                        </li>
                    </ul>
                </li>
                <li class="menu nav-item">
                    <button type="button" class="nav-link group"
                        :class="{ 'active': activeDropdown === 'cards' }"
                        @click="activeDropdown === 'cards' ? activeDropdown = null : activeDropdown = 'cards'">
                        <div class="flex items-center">
                            ...
                            <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Card</span>
                        </div>
                        <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'cards' }">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'cards'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="/building-admin/card-index">List</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group"
                        ...
                        <div class="flex items-center">
                            ...
                            <span
                                class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Sub User</span>
                        </div>
                    ...
                    <ul x-cloak x-show="activeDropdown === 'components'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="/building-admin/sub-tenant">List</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group" :class="{ 'active': activeDropdown === 'elements' }"
                        ...
                        <div class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="64" height="64">
                                <!-- Book/Log outline -->
                                <rect x="12" y="8" width="40" height="48" stroke="black" stroke-width="2" fill="white" rx="4" ry="4"/>

                                <!-- Horizontal lines representing text entries -->
                                <line x1="20" y1="18" x2="44" y2="18" stroke="black" stroke-width="2"/>
                                <line x1="20" y1="28" x2="44" y2="28" stroke="black" stroke-width="2"/>
                                <line x1="20" y1="38" x2="44" y2="38" stroke="black" stroke-width="2"/>
                                <line x1="20" y1="48" x2="44" y2="48" stroke="black" stroke-width="2"/>
                                ...
                                <circle cx="52" cy="52" r="6" stroke="black" stroke-width="2" fill="white"/>
                                <line x1="52" y1="52" x2="52" y2="48" stroke="black" stroke-width="2"/>
                                <line x1="52" y1="52" x2="54" y2="54" stroke="black" stroke-width="2"/>
                              </svg>
            ...
            <li class="menu nav-item">
                <a href="/building-admin/ticket-dashboard" class="nav-link group">
                    <div class="flex items-center">
                        <svg class="group-hover:!text-primary shrink-0" width="20" height="20" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path opacity="0.5"
            ...
            <li class="menu nav-item">
                <button type="button" class="nav-link group"
                    ...
                    <div class="flex items-center">
                        ...
                        <span
                            class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">My Ticket</span>
                    </div>
                ...
                <ul x-cloak x-show="activeDropdown === 'tickets'" x-collapse class="sub-menu text-gray-500">
                    <li>
                        <a href="/building-admin/myTicket-index">List</a>
                    </li>
                    <li>
                        <a href="/building-admin/myTicket-create">Add</a>
                    </li>
                </ul>
            </li>
            <li class="menu nav-item">
                <a href="/building-admin/new-ticket" class="nav-link group">
                    <div class="flex items-center">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path opacity="0.5" d="M3.77772 18.3259C4.78661 19 6.19108 19 9 19L15 19C17.8089 19 19.2134 19 20.2223 18.3259C20.659 18.034 21.034 17.659 21.3259 17.2223C22 16.2134 22 14.8089 22 12C22 9.19107 22 7.78661 21.3259 6.77772C21.034 6.34096 20.659 5.96595 20.2223 5.67412C19.2134 5 17.8089 5 15 5H9C6.19108 5 4.78661 5 3.77772 5.67412C3.34096 5.96596 2.96596 6.34096 2.67412 6.77772C2 7.78661 2 9.19108 2 12C2 14.8089 2 16.2134 2.67412 17.2223C2.96596 17.659 3.34096 18.034 3.77772 18.3259Z" fill="currentColor"></path>
                            <path d="M5.5 15.75C5.08579 15.75 4.75 15.4142 4.75 15L4.75 9C4.75 8.58579 5.08579 8.25 5.5 8.25C5.91421 8.25 6.25 8.58579 6.25 9L6.25 15C6.25 15.4142 5.91421 15.75 5.5 15.75Z" fill="currentColor"></path>
            ...
            <li class="menu nav-item">
                <a href="/building-admin/open-ticket" class="nav-link group">
                    <div class="flex items-center">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path opacity="0.5" d="M3.77772 18.3259C4.78661 19 6.19108 19 9 19L15 19C17.8089 19 19.2134 19 20.2223 18.3259C20.659 18.034 21.034 17.659 21.3259 17.2223C22 16.2134 22 14.8089 22 12C22 9.19107 22 7.78661 21.3259 6.77772C21.034 6.34096 20.659 5.96595 20.2223 5.67412C19.2134 5 17.8089 5 15 5H9C6.19108 5 4.78661 5 3.77772 5.67412C3.34096 5.96596 2.96596 6.34096 2.67412 6.77772C2 7.78661 2 9.19108 2 12C2 14.8089 2 16.2134 2.67412 17.2223C2.96596 17.659 3.34096 18.034 3.77772 18.3259Z" fill="currentColor"></path>
                            <path d="M5.5 15.75C5.08579 15.75 4.75 15.4142 4.75 15L4.75 9C4.75 8.58579 5.08579 8.25 5.5 8.25C5.91421 8.25 6.25 8.58579 6.25 9L6.25 15C6.25 15.4142 5.91421 15.75 5.5 15.75Z" fill="currentColor"></path>
            ...
            <li class="menu nav-item">
                <a href="/building-admin/hold-ticket" class="nav-link group">
                    <div class="flex items-center">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path opacity="0.5" d="M3.77772 18.3259C4.78661 19 6.19108 19 9 19L15 19C17.8089 19 19.2134 19 20.2223 18.3259C20.659 18.034 21.034 17.659 21.3259 17.2223C22 16.2134 22 14.8089 22 12C22 9.19107 22 7.78661 21.3259 6.77772C21.034 6.34096 20.659 5.96595 20.2223 5.67412C19.2134 5 17.8089 5 15 5H9C6.19108 5 4.78661 5 3.77772 5.67412C3.34096 5.96596 2.96596 6.34096 2.67412 6.77772C2 7.78661 2 9.19108 2 12C2 14.8089 2 16.2134 2.67412 17.2223C2.96596 17.659 3.34096 18.034 3.77772 18.3259Z" fill="currentColor"></path>
                            <path d="M5.5 15.75C5.08579 15.75 4.75 15.4142 4.75 15L4.75 9C4.75 8.58579 5.08579 8.25 5.5 8.25C5.91421 8.25 6.25 8.58579 6.25 9L6.25 15C6.25 15.4142 5.91421 15.75 5.5 15.75Z" fill="currentColor"></path>
            ...
            <li class="menu nav-item">
                <a href="/building-admin/close-ticket" class="nav-link group">
                    <div class="flex items-center">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path opacity="0.5" d="M3.77772 18.3259C4.78661 19 6.19108 19 9 19L15 19C17.8089 19 19.2134 19 20.2223 18.3259C20.659 18.034 21.034 17.659 21.3259 17.2223C22 16.2134 22 14.8089 22 12C22 9.19107 22 7.78661 21.3259 6.77772C21.034 6.34096 20.659 5.96595 20.2223 5.67412C19.2134 5 17.8089 5 15 5H9C6.19108 5 4.78661 5 3.77772 5.67412C3.34096 5.96596 2.96596 6.34096 2.67412 6.77772C2 7.78661 2 9.19108 2 12C2 14.8089 2 16.2134 2.67412 17.2223C2.96596 17.659 3.34096 18.034 3.77772 18.3259Z" fill="currentColor"></path>
                            <path d="M5.5 15.75C5.08579 15.75 4.75 15.4142 4.75 15L4.75 9C4.75 8.58579 5.08579 8.25 5.5 8.25C5.91421 8.25 6.25 8.58579 6.25 9L6.25 15C6.25 15.4142 5.91421 15.75 5.5 15.75Z" fill="currentColor"></path>
                ...
                <li class="menu nav-item">
                    <a href="/building-admin/profile" class="nav-link group">
                        <div class="flex items-center">
                ...
                <li class="menu nav-item">
                    <a href="/building-admin/password-reset" class="nav-link group">
                        <div class="flex items-center">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Password Reset</span>
                        </div>
                    </a>
                </li>

                <li class="menu nav-item">
                    <a href="/building-admin/key-reset" class="nav-link group">
                        <div class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="100" height="100" fill="none" stroke="black" stroke-width="3">
                                <g>
                                  <!-- Circular arrow for reset -->
                                  <path d="M50 20 A30 30 0 1 1 20 50" fill="none" stroke="black" stroke-width="3"/>
                                  <polygon points="18,45 20,55 25,50" fill="black"/>

                                  <!-- Key shape -->
                                  <rect x="40" y="50" width="30" height="10" rx="2" ry="2" fill="black"/>
                                  <circle cx="35" cy="55" r="8" fill="none" stroke="black" stroke-width="3"/>
                                  <rect x="70" y="52" width="5" height="6" fill="black"/>
                                  <rect x="76" y="52" width="5" height="6" fill="black"/>
                                </g>
                              </svg>


                            <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Key Reset</span>
                        </div>
                    </a>
                </li>
