<x-layout.default>
    ...
    <style>
        ...
        <form action="{{ route('super-admin.building-update', $value->id) }}" method="POST">
            @csrf
            @method('PUT')
        ...
        <br>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                    ...
                    <input id="schoolId" type="text" name="schoolId" value="{{ $value->school_id ?? '' }}" placeholder="Auto Generate"  class="form-input" readonly/>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <input id="security" name="security" type="number" value="{{ $value->no_security_person ?? '' }}" placeholder="no security person" class="form-input" required />
                </div>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                    <label for="address_1"><strong>Address 1</strong></label>
                    <input id="address_1" type="text" name="address_1" value="{{ $value->address_1 ?? '' }}" placeholder="address 1" class="form-input" required/>
                </div>
                <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                <div>
                    ...
                    <input id="business_name" type="text" name="business_name" value="{{ $value->business_name ?? '' }}" placeholder="business name" class="form-input"  />
                </div>
                <div>
                    <label for="password"><strong>Password<span class="text-red-500">*</span></strong></label>
                    <input id="password" type="text" name="password" placeholder="password" class="form-input"  />
                </div>
                <div>
