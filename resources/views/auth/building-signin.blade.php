...
<script>
    function updateFormAction() {
        ...
        const selectedValue = document.getElementById('redirectUrl').value;

        // Update form action URL based on selected option
        if (selectedValue === 'building') {
            form.action = '/building/dashboard';  // Building specific URL
        } else if (selectedValue === 'security') {
            form.action = '/building-security/login';  // Security specific URL
        } else if (selectedValue === 'tenant') {
            form.action = '/building-tenant/login';    // Tenant specific URL
        }
    }
</script>
