<x-layout.default>
    ...
    <div class="panel shadow-lg rounded-lg p-8 max-w-6xl mx-auto " style="border-color: #a8acaf; border-width: medium;">
        <div class="flex justify-center mb-4">
            <h1 class="text-2xl font-bold">Building</h1>
        </div>
        ...
        <br>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                    ...
                    <input id="buildingId" type="text" name="buildingId" placeholder="Auto Generate" value="{{ $nextId }}" class="form-input"  readonly />
                    <input type="hidden" name="type" value="building"/>
                </div>
                <div>
                    <label for="buildingname"><strong>Building Name</strong></label>
                    <input id="buildingname" name="buildingname" type="text" placeholder="Enter Building Name" class="form-input" required/>
                </div>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
