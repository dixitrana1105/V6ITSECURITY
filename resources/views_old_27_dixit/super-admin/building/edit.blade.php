<x-layout.default>
    ...
    <style>
        ...
        <br>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                    <label for="notenant"><strong>No. Of Users</strong></label>
                    <input id="notenant" name="notenant" type="number" placeholder="no Users person" value="{{ $value->no_of_tenant ?? ''}}" class="form-input" required/>
                </div>
                <div>
