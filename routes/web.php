...
Route::post('/security-send-message', [BuildingsTenantTenController::class, 'sendTMessage'])->name('security-send-message');
...
Route::post('/building-tenant/unblock-tenant', [BuildingsTenantVisitorController::class, 'unblockTenant'])->name('unblock-tenant');
...
Route::get('/tenant-newMessages/', [MessagesController::class, 'redirectTotenantMessagePage'])->name('messages.new.tenant');
...
Route::get('/download-sample-csv', function () {
    $headers = [
        ...
        'Content-Disposition' => 'attachment; filename="student_sample.csv"',
    ];
    ...
    $callback = function () {
        ...
        $students = [
            ['120001', 'abc', 'kkkk', 'uuuu', '12', 'A', '45555555', '56465', 'admin@123', 'zaaaa', '1', '633333'],
            ['120002', 'bcd', 'llll', 'vvvv', '11', 'B', '5455545', '84654', 'admin@45545', 'bccc', '1', '633333'],
        ];
